...
const ClientCarousel = () => {
  const clients = [
    ...
    { name: 'LaoHuZhengQuan', logo: '/client-logo/LaoHuZhengQuan.jpg' },
    { name: 'Webull', logo: '/client-logo/Webull_Logo.jpg' },
    { name: 'China Life', logo: '/client-logo/chinalife_shop_logo_540_360.jpg' },
    { name: 'HKU', logo: '/client-logo/university-of-hong-kong-logo-png_seeklogo-456366.png' },
    { name: 'Forthright', logo: '/client-logo/medium_forthright_logo_af267c1c7b.webp' },
